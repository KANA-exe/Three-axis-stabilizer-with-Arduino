...
//variable for time 
uint32_t timepoint=0;//the time that the loop was implemented
uint32_t timepointBefore=0;//the time that the loop was finish
uint32_t deltaTime;//Difference between timepoint and timepointBefore
int32_t detecttime=10000;//when totaltime large than that,the microcontroller will calculate the angle that the servo need
